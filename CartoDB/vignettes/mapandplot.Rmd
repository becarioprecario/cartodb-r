---
title: "Mapping and plotting data side by side with CartoDB and R"
author: "Andrew Hill (original author), Virgilio Gómez-Rubio"
date: "`r Sys.Date()`"
output: rmarkdown::html_vignette
vignette: >
  %\VignetteIndexEntry{Mapping and plotting data side by side with CartoDB and R}
  %\VignetteEngine{knitr::rmarkdown}
  %\VignetteEncoding{UTF-8}
---


## Mapping and plotting data side by side

<img src="http://i.imgur.com/AuJJL.png" width="900px"/>
